...
const Navbar =() => {
  ...
  <nav className="sticky top-0 z-50 w-full bg-[#FBEBB5] flex flex-row sm:flex-row justify-between items-center px-4 sm:px-8 py-4">
        ...
        >
          {/* Links Section */}
          <div className="flex flex-col sm:flex-1 sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-14">
            <Link
              href="/"
        ...
        {/* Icons Section */}
        <div className="flex justify-center pr-4 sm:pr-8 md:pr-12 lg:pr-20 space-x-8 sm:space-x-11 text-[20px] sm:text-[24px] sm:mt-0">
        <Link href="/accounts">
